            ...
            <div className="col-md-12">
                ...
                <div className="col-md-12">
                    ...
                    <p>Hi there! I'm Nikita.<br/>
                      I'm a passionate software developer and a savvy programmer, always seeking new opportunities to devise innovative solutions that impact peoples' lives.</p>
                    <p>Being a recent Computer Science Engineering graduate from BITS Pilani Dubai, I have worked on a handful of academic and personal projects, that showcase my interest in the field of development. I have 8 months of professional work experience and have profound knowledge in all phases of the software development lifecycle - from business requirement analysis to design, implementation and testing.</p>
